...
Тестовое задание на React: дашборд пользователей с таблицей, просмотром карточки пользователя и заделом под форму редактирования.
...
![Список пользователей](docs/users-table.png)
